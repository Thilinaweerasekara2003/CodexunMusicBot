...
async def check(_, message: Message):
    ...
    if update_avail:
        ...
        return
    await msg.edit("Bot is already in up-to-date mode with **[latest version](https://github.com/Thilinaweerasekara2003/CodexunMusicBot)**", disable_web_page_preview=True)
